            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'isuse', title: __('Isuse'), searchList: {"self":__('Self'),"sale":__('Sale'),"lease":__('Lease'),"authorize":__('Authorize')}, formatter: Table.api.formatter.status},
                        {field: 'iszt', title: __('Iszt'), searchList: {"yes":__('Yes'),"no":__('No'),"ok":__('Ok'),"apply":__('Apply'),"unbind":__('Unbind')}, formatter: Table.api.formatter.status},
