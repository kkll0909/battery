            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'totype', title: __('Totype'), searchList: {'plat' : __('Plat'),'member' : __('Member'),'user' : __('User')},formatter: Table.api.formatter.status},
                        {field: 'type', title: __('Type'), searchList: {'msg' : __('Msg'),'sys' : __('Sys'),'order' : __('Order'),'pay' : __('Pay')},formatter: Table.api.formatter.status},
                        ...
                        {field: 'readsum', title: __('Readsum'), operate:false},
