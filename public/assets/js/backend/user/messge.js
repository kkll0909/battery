define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'user/messge/index' + location.search,
                    add_url: 'user/messge/add',
                    edit_url: 'user/messge/edit',
                    del_url: 'user/messge/del',
                    multi_url: 'user/messge/multi',
                    import_url: 'user/messge/import',
                    table: 'message',
                }
            });
